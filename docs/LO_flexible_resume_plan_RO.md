...
Faza 2 (Rollback + versionare parametri)
...
- Snapshot LO „enhanced”: directorul `apps/lidar_odometry_step_1_enhanced00/`
...
## Tag‑uri în traiectorie (opțional, extensibil)
